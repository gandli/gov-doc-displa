  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-white">
      <header className="px-6 py-4 bg-blue-600 text-white">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link href="#" className="text-blue-100 hover:text-white">首页</Link>
            <Link href="#" className="text-blue-100 hover:text-white">信息公开</Link>
            <Link href="#" className="text-blue-100 hover:text-white">在线服务</Link>
            <Link href="#" className="text-blue-100 hover:text-white">政策解读</Link>
          </nav>
      ...
      <main className="flex-1">
        <section className={`${theme.secondary} py-12 md:py-24 lg:py-32`}>
      ...
      <footer className={`${theme.muted} py-6 border-t border-blue-200 `}>
